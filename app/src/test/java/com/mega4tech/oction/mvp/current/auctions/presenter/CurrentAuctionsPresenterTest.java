...
/**
 * Created by aboodba on 16/06/2017.
 */
public class CurrentAuctionsPresenterTest {


    @Rule
    public MockitoRule mockitoRule = MockitoJUnit.rule();
    @Mock
    CurrentAuctionsInteractor interactor;
    @Mock
    CurrentAuctionsView view;
    @Mock
    Repository repository;
    @Mock
    Application application;
    @InjectMocks
    CurrentAuctionsPresenterImpl presenter;
